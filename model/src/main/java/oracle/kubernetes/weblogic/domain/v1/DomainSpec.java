...
public class DomainSpec extends BaseConfiguration {
   ...
   */
  @JsonPropertyDescription("The Weblogic Docker image; required when domainHomeInImage is true; " +
   ...
   */
  @JsonPropertyDescription("The image pull policy for the WebLogic Docker image. " + "" +
   ...
   *
   * <p>More info: https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.10/#localobjectreference-v1-core
   *
   * @since 2.0
   */
  ...
  @Expose
  @JsonPropertyDescription("The storage used for this domain. " +
